...
const BANNERS = [
  ...
  {img:'banner-combo-oculos-pulseira.jpg',tag:'Lunah Atelier',h:'O presente<br><em>completo</em>',p:'Óculos + Pulseira Olho de Tigre por R$149.',cta:'Montar combo',msg:'Olá! Quero o combo Óculos + Pulseira por R$149.'},
  {img:'banner-oculos-preco.jpg',tag:'Lunah',h:'Design que<br><em>marca</em> presença',p:'Óculos com design editorial. R$99 à vista ou em até 12x.',cta:'Ver coleção',msg:'Olá! Quero comprar um óculos Lunah.'},
  {img:'banner-atelier-pulseiras.jpg',tag:'Lunah Atelier',h:'Energia que<br><em>transforma</em>',p:'Pulseiras com pedras naturais. R$69 ou em até 12x.',cta:'Ver pulseiras',msg:'Olá! Quero conhecer as pulseiras Lunah Atelier.'},
  ...
  {img:'banner-2pulseiras.jpg',tag:'Essências',h:'Escolha sua<br><em>energia</em>',p:'2 pulseiras por R$129. Amor que acolhe.',cta:'Escolher',msg:'Olá! Quero o combo 2 pulseiras por R$129.'},
];
...
].map(([name,line,desc,f,s,shape])=>({type:'glasses',name,line,desc,shape,price:'<strong>R$99</strong> à vista<br>ou em até <strong>12x</strong>',bullets:['Proteção UV400','Acabamento premium','Design exclusivo Lunah'],images:[`${f}.jpg`,`${s}.jpg`]}));
...
].map(([name,line,desc,f,s])=>({type:'glasses',name,line,desc,shape:'oval',price:'<strong>R$99</strong> à vista<br>ou em até <strong>12x</strong>',bullets:['Proteção UV400','Armação sem aro','Design exclusivo Lunah'],images:[`${f}.jpg`,`${s}.jpg`]}));
...
].map(([name,line,desc,f,s])=>({type:'glasses',name,line,desc,shape:'redondo',price:'<strong>R$99</strong> à vista<br>ou em até <strong>12x</strong>',bullets:['Armação de grau','Design Lunah Vision','Acabamento premium'],images:[`${f}.jpg`,`${s}.jpg`]}));
...
function card(p, i, col) {
  ...
  const badge = NOVO.has(p.name) ? '<span class="pcard-badge badge-novo">Novo</span>' : '';
  const priceLabel = `<strong>${isG?'R$99':'R$69'}</strong>`;
